    ...
    <div className="max-w-[960px] mx-auto px-6 py-20 space-y-16">
      ...
      <div className="p-5 rounded-xl bg-[#13110e] border border-[#2e2b26] space-y-3">
        ...
        <div className="border-t border-[#2e2b26] pt-3 space-y-2 font-body text-base text-[#c8c2ba] leading-relaxed">
          ...
          <p><span className="text-[#f2ebeb]">Character Type:</span> Flat, <a href="https://alarkiusej.medium.com/the-square-character-taxonomy-alarkiusej-45f469704264" target="_blank" rel="noopener noreferrer" className="text-[#c9a84c] hover:underline">Square</a>, Round &amp; Dynamic</p>
        </div>
      </div>
