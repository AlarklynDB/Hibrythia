        ...
        <div className="space-y-3 mt-4">
          ...
          <PowerToggle title="Infernal Magic" color="#f87171">
            ...
            <div className="pt-2 border-t border-[#2e2b26] space-y-3">
              ...
              <p className="font-body text-sm text-[#c8c2ba] leading-relaxed">Then comes the nasty part. Every subpower of Infernal Magic gets used and consumed at a huge amount, simultaneously. After the huge consumption of energy and power for Infernal Magic, this will render the user immobile for an hour if trained correctly. If not, this will render the user immobile for a day. Also, even if she dies, Infernal Magic will revive her no matter what, restoring her back to who she was, before, and after, while this set itself evolves after usage. Raeya now has complete mastery and control over this magic as of <span className="text-[#c9a84c] italic">&ldquo;Hibryds I - A Grand Voyage, EP 13 - Mastery.&rdquo;</span></p>
            </div>
          </PowerToggle>
