...
//
// Lore Word Count — loreWordCount.json is regenerated by
// scripts/count-lore-words.mjs on every `dev`/`build` run (see
// package.json), so this total silently re-syncs itself whenever
// lore is added or edited. No manual step required.
// ============================================================
