          ...
          <div className="space-y-8">
            ...
            <div className="border border-[#c9a84c]/20 rounded-sm bg-[#0f0d0c] px-5 py-5">
              ...
              <div className="space-y-1 mb-4">
                <p className="font-body text-base text-[#c8c2ba] leading-relaxed"><strong className="text-[#f2ebeb]">Anzeya</strong> › Anzeya is Hetra's main moon that orbits around the planet. Anzeya has rings that are composed of Hetranium and Hexicules.</p>
                <p className="font-body text-base text-[#c8c2ba] leading-relaxed"><strong className="text-[#f2ebeb]">Zenya</strong> › Zenya is Anzeya's moon satellite.</p>
              </div>
